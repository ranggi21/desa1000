    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Desa Wisata Saribu Rumah Gadang</p>
            </div>
                            ...
                            <div class="dropdown">
                                        ...
                                        <div class="card-body py-3 px-4">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-lg me-0">
                                                    <img src="<?= base_url('media/photos'); ?>/<?= user()->photo; ?>" alt="Face 1" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <?php if (in_groups('user')) : ?>
                                        <a class="dropdown-item" href="<?= base_url('web/reservation') . '/' . user()->id ?>">My Reservation</a>
                                    <?php endif; ?>
