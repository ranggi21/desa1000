    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/atraction/update') . '/' . $data['id'] : base_url('dashboard/atraction'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                            <div class="form-group mb-4">
                                <label for="geo-json" class="mb-2">GeoJSON <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="mb-2">Atraction Name <span class="text-danger">*</span> </label>
                                <input type="text" id="name" class="form-control" name="name" placeholder="Atraction Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <div class="form-group mb-4">
                                <label for="open" class="mb-2">Opening Hours <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group mb-4">
                                <label for="close" class="mb-2">Closing Hours <span class="text-danger">*</span></label>
                                <div class="input-group">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="latitude" name="latitude" placeholder="eg. -0.52435750" value="<?= ($edit) ? $data['lat'] : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="latitude">Longitude <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="longitude" name="longitude" placeholder="eg. 100.49234850" value="<?= ($edit) ? $data['lng'] : ''; ?>" required>
                            </div>
                        </div>
                        <div class="col-auto mx-1">
                            <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Search" class="btn icon btn-outline-primary" onclick="findCoords('AT');">
...
<script>
    ...
    function checkRequired(event) {
        if (!$('#geo-json').val()) {
            ...
            Swal.fire('Please select location for the New Atraction');
        }
    }
</script>
<script>
