                    ...
                    <form class="form form-vertical" action="<?= ($edit) ? base_url('dashboard/rumahGadang/update') . '/' . $data['id'] : base_url('dashboard/rumahGadang'); ?>" method="post" onsubmit="checkRequired(event)" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="name" class="form-control" name="name" placeholder="Rumah Gadang Name" value="<?= ($edit) ? $data['name'] : old('name'); ?>" required>
                            </div>
                            <div class="form-group mb-4">
                            ...
                            <?php else : ?>
                                <fieldset class="form-group mb-4">
                                    ...
                                    <select class="form-select" id="ownerSelect" name="owner">
                                    </select>
                                </fieldset>
                            <?php endif; ?> -->
                            <div class="form-group mb-4">
